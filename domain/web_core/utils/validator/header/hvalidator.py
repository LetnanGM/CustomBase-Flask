from ....bootstrap import (SecurityConfig, CSRFLogger)
from share.support.parser.url import URLParse as URLHelper
from typing import Tuple

class Header:
    def __init__(self, request_host: str, method: str, origin: str, referer: str) -> None:
    ...
    def referrer_validator(self, referrer: str) -> Tuple[bool, str]:
        ...
        if referrer_host != request_host and referrer not in SecurityConfig.TRUSTED_ORIGIN:
