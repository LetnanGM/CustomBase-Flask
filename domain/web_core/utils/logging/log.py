...
protector_logger = Logger(log_file="assets/logs/Protector/protect/Session-protector-[time].log")
...
SMiddleware_logger = Logger(log_file="assets/logs/Protector/SecurityMiddleware/SMiddleware-[time].log")
