...
class SecurityMiddleware:
    ...
    def __init__(self, app: Flask):
        from domain.web_core.protector import (RateLimiter, InputValidator)
    ...
    def before_request(self):
        ...
        if self.rate_limiter.is_blocked(ip):
            ...
            abort(403, description="Access forbidden. Your IP has been temporarily blocked.")
    ...
    def _validate_request_data(self):
        ...
        if request.is_json:
            try:
                ...
                self._log.vsilent(
                    f"Error validating JSON data: {str(e)}",
                    extra={'ip': ip}
                )
