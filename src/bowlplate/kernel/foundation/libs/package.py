...
class package:
    ...
    @validate_parameter({"alias": str, "instance_object": Type | Callable})
    def alias(alias: str, instance_object: Type | Callable):
        from bowlplate.share.builtns.exceptions import NameAliasAlreadyInUse
