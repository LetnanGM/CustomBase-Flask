...
class DBase:
    ...
    @property
    def configs(self):
        self.db.cur.execute("SELECT key FROM config")
...
CREATE TABLE IF NOT EXISTS config (
    ...
    def insert(
        self, column_name: str, json_data: dict | str, force_update: bool = False
    ) -> None:
        """ """
    ...
    def _loader(self) -> None:
        ...
        for file in base.rglob(f"*.{self.suffix}"):
            try:
                ...
                self.db.insert(column_name=file.name, json_data=data)
