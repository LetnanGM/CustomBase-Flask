...
from domain.web_core.utils import Header
from domain.web_core.utils.crypto.encryption import safe_str_cmp
from .csrf import CSRFHelper, CSRFLogger, CSRFViolation, Detector, _PrivModel
...
class CSRFProtection(_PrivModel):
    ...
    def _setup_csrf_protection(self) -> None:
        ...
        def set_csrf_cookie(response):
            ...
            from bootstrap.bootstrap import RegistryContextProcessor as rcp
